...
balance_qa = json.load(open("anetqa_train.json"))+json.load(open("anetqa_val.json"))+json.load(open("anetqa_test.json"))
keys=[]
questions=[]
answers=[]
vid_ids=[]
...
print(len(video))
video_train =json.load(open("video_train.json"))
video_val = json.load(open("video_val.json"))
video_test =json.load(open("video_test.json"))
